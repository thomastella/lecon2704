...
class Player(BasePlayer):
    ...
    E1 = models.StringField(choices=[['A', 'NO CHANGE '], ['B', 'For example, '], ['C', 'In contrast,'], ['D', 'Nevertheless']], label='1. Choose the best answer:')
    E2 = models.StringField(choices=[['A', 'NO CHANGE'], ['B', 'speaking in a more pragmatic way, '], ['C', 'speaking in a way more pragmatically, '], ['D', 'in a more pragmatic-speaking way,']], label='2. Choose the best answer:')
    E3 = models.StringField(choices=[['A', 'NO CHANGE '], ['B', 'teaches '], ['C', 'to teach '], ['D', 'and teaching']], label='3. Choose the best answer:')
    ...
    E5 = models.StringField(choices=[['A', 'NO CHANGE '], ['B', 'Thus, '], ['C', 'Moreover, '], ['D', 'However, ']], label='5. Choose the best answer:')
